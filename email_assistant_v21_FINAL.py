...
}  # Static fallback; replaced at runtime by fetch_oas_vessels() when OAS API is available
        ...
        if response.status_code in (401, 403):
            ...
            try:
                ...
                ctypes.windll.user32.MessageBoxW(
                    0,
                    "OAS token expired.\n\nPlease run refresh_token_helper_TOOL.py to refresh it.",
...
def run_summary_agent():
    ...
    try:
        ...
        # Refresh OAS vessel list on every cycle
        _, oas_vessels = fetch_oas_vessels()
        timeline = load_timeline()  # now contains merged OAS data
